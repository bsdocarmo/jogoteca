...
print('Conectando...')
conn = MySQLdb.connect(user='root', passwd='br32236687', host='localhost', port=3306)
...
# Descomente se quiser criar o banco...
...
cursor.executemany(
    ...
    [
        ('Bruno', 'Bruno do Carmo', '1234567'),
        ('Arthur', 'Arthur do Carmo', '777')
    ])
